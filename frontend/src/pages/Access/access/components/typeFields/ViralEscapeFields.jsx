  ...
  return (
    <section className={sectionClass}>
      <div className="grid gap-5">
        ...
        <label className="font-semibold">Descrição curta do card<textarea className={`${fieldClass} min-h-28 resize-y`} value={form.description} onChange={actions.update("description")} /></label>
      </div>
    </section>
  );
}
