  ...
  return (
    <section className={sectionClass}>
      <div className="grid gap-5">
        ...
        <label className="font-semibold">Biografia ou descrição<textarea className={`${fieldClass} min-h-36 resize-y`} value={form.description} onChange={actions.update("description")} /></label>
        <p className="text-sm leading-6 text-muted">Ao publicar, o autor entra automaticamente na navegação de Artigos e recebe uma página dinâmica própria.</p>
      </div>
    </section>
  );
}
