  ...
  return (
    <section className={sectionClass}>
      <div className="grid gap-5">
        <label className="font-semibold">Descricao<textarea className={`${fieldClass} min-h-36 resize-y`} value={form.description} onChange={actions.update("description")} /></label>
