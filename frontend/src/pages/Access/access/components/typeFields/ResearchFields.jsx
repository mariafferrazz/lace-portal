  ...
  return (
    <section className={sectionClass}>
      <div className="grid gap-5">
        ...
        <PeopleFields title="Equipe" description="Nome, funcao, descricao e Lattes. Todos os campos sao opcionais." items={form.researchTeam} onAdd={() => actions.addObject("researchTeam", actions.emptyPerson)} onRemove={(index) => actions.removeObject("researchTeam", index, actions.emptyPerson)} onChange={(index, field, value) => actions.updateObject("researchTeam", index, field, value)} />
