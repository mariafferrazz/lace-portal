...
const playlistUrl = "https://www.youtube.com/playlist?list=PLgImeU9gw9828y6bUwXk0xHnKlk7uSZl_";

const playlistVideos = [
  {
    id: "3y6GG61RCpg",
    title: "VI Mostra Cinema e Ditadura - Irmãos Carvalho - Retrato da Resistência Operária Contra a Ditadura",
    shortTitle: "Irmãos Carvalho - Retrato da Resistência Operária Contra a Ditadura",
    thumbnail: "https://i4.ytimg.com/vi/3y6GG61RCpg/hqdefault.jpg",
    meta: "986 visualizações · Transmitido em 09/12/2024",
    date: "09/12/2024",
    titleFontSize: "1.7rem",
  },
  {
    id: "krOvUNjhGyU",
    title: "VI Mostra Cinema e Ditadura - Calabouço, Um Tiro no Coração do Brasil",
    shortTitle: "Calabouço, Um Tiro no Coração do Brasil",
    thumbnail: "https://i4.ytimg.com/vi/krOvUNjhGyU/hqdefault.jpg",
    meta: "455 visualizações · Transmitido em 10/12/2024",
    date: "10/12/2024",
    titleFontSize: "2rem",
  },
  {
    id: "y-NofZQLIAg",
    title: "VI Mostra Cinema e Ditadura - O Canto da Terra",
    shortTitle: "O Canto da Terra",
    thumbnail: "https://i2.ytimg.com/vi/y-NofZQLIAg/hqdefault.jpg",
    meta: "153 visualizações · Transmitido em 11/12/2024",
    date: "11/12/2024",
    titleFontSize: "2.2rem",
  },
  {
    id: "_7hLCmXOFio",
    title: "Guerra Sem Fim - Resistência e Luta do Povo Krenak",
    shortTitle: "Guerra Sem Fim - Resistência e Luta do Povo Krenak",
    thumbnail: "https://i4.ytimg.com/vi/_7hLCmXOFio/hqdefault.jpg",
    meta: "70 visualizações · Transmitido em 12/12/2024",
    date: "12/12/2024",
...
export default function MostraVI() {
    ...
    <main className="bg-background py-20 lg:py-28">
      <Container>
        <header className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-primary">Cinema e Ditadura · 2024</p>
            <h1 className="mt-4 font-title text-5xl leading-tight md:text-7xl">VI Mostra Cinema e Ditadura</h1>
            <p className="mt-6 text-lg leading-8 text-muted">
              A VI Mostra Cinema e Ditadura reúne debates e transmissões sobre memória, resistência, trabalho, juventude,
              povos originários e os impactos históricos da ditadura empresarial-militar brasileira.
            </p>
          </div>
          <figure className="overflow-hidden rounded-3xl border border-border bg-card shadow-2xl">
            <img
              ...
              alt="Registro da VI Mostra Cinema e Ditadura"
            />
          </figure>
        </header>
        ...
        <button
          ...
          aria-label="Abrir playlist completa da VI Mostra"
        >
          <span>
            <span className="block text-sm font-semibold uppercase tracking-[0.25em] text-primary">Transmissões gravadas</span>
            <span className="mt-3 block font-title text-4xl">Playlist completa da VI Mostra</span>
            <span className="mt-3 block text-muted">Registros das transmissões realizadas em dezembro de 2024.</span>
          </span>
        ...
        <section className="mt-16">
          <div className="flex items-center gap-3 text-primary">
            ...
            <h2 className="font-title text-4xl text-text md:text-5xl">Calendário 2024</h2>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              <section className="rounded-3xl border border-border bg-card p-5">
                ...
                <h2 id="playlist-modal-title" className="mt-3 font-title text-4xl md:text-5xl">
                  VI Mostra Cinema e Ditadura
                </h2>
                <p className="mt-3 text-muted">Playlist · 4 vídeos · por LACE</p>
                <a
