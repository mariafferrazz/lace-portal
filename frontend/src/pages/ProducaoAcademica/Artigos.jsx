...
const legacyAuthorsFallback = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary:
          "Percorrendo os diferentes tempos provocados pela peça A Pandorga e a Lei (1983-1984), de João das Neves, este artigo pretende pensar as relações entre memória e crise no Brasil contemporâneo, a partir do conceito de duração e dos seus desdobramentos, inaugurado por Henri Bergson. Foi feita a leitura pública desta peça, pela primeira vez, no I Seminário do Grupo Tortura Nunca Mais-RJ, ocorrido nos dias 28, 29, 30 e 31 de outubro e 1º de novembro de 1985, na Universidade Cândido Mendes. Este seminário formalizou a fundação do GTNM-RJ. Nossas reflexões têm como ponto de partida a ditadura empresarial-militar brasileira. Mais do que um tempo linear, cronológico e quantitativo, o tempo da duração é múltiplo e qualitativo. Nele, passado, presente e futuro interagem incessantemente, suscitam problemas, reativam feridas, cicatrizes e abrem brechas. Atravessar as fronteiras do tempo, olhar para os horrores do passado, perceber o que há desse passado no presente e atentar para o que ele pode nos acenar para o futuro impõe-se como desafio à compreensão do panorama contemporâneo brasileiro.",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        note: "Cecilia Maria Bouças Coimbra, Ana Monteiro de Abreu",
        summary:
          "Movidas pela afirmação de Gilles Deleuze, que qualifica o Maio de 68 francês como um acontecimento, passamos a nos perguntar: qual o significado dessa afirmação? O que esse conceito filosófico expressa? Poderíamos considerar Junho de 2013 no Brasil um acontecimento? Este texto surge no percurso desafiador dessas interrogações. Além das contribuições de Gilles Deleuze, contamos com interlocuções de outros pensadores, como Félix Guattari, Friedrich Nietzsche e Michel Foucault.",
      },
      {
    ...
    articles: [
      {
        ...
        summary:
          "Este trabalho tem como objetivo buscar uma compreensão do que é a psicologia para Nietzsche, tendo em vista que, em diversos momentos de sua obra, a palavra psicologia aparece e aponta caminhos que se entrecruzam com uma crítica à filosofia, à moral, à religião e à ciência. Para tanto, o filósofo utiliza, como critérios de avaliação, os conceitos de força e fraqueza, saúde e doença e busca, como psicólogo, investigar e diagnosticar a saúde de uma cultura a partir dessa base, pautado na arte da interpretação dos sintomas manifestos na vida. Nesse sentido, após caracterizarmos a força do povo helênico por meio da tragédia grega e seu declínio, com a introdução da metafísica socrática como opositora à vida, buscamos compreender os efeitos dessa oposição no modo de ser do homem ocidental. Posteriormente, discutimos os desdobramentos da metafísica no plano da moralidade, no qual a psicologia surge como reprodutora desse ideal, isto é, presa a temores e preconceitos morais. Seguimos, então, a proposta de uma nova psicologia, pautada em outros valores, mais próximos da vida em sua forma plena, ou seja, entendida como vontade de potência. Para tanto, o método que nos guia nesse percurso é a genealogia, que, ao indagar as condições e circunstâncias nas quais os valores surgem, aponta para a vida como avaliadora, tendo o homem como seu instrumento de avaliação. Ao psicólogo cabe avaliar e interpretar a vida estampada na visão do homem e, portanto, na cultura surgida por meio dele. Nesse novo percurso, busca-se afirmar o trágico como condição de uma existência saudável, não mais pautada no bem e no mal, mas para além do bem e do mal.",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary:
          'NOS ÚLTIMOS ANOS, NÃO APENAS NO BRASIL, HOUVE UM CRESCIMENTO SIGNIFICATIVO DO QUE TEM SIDO CHAMADO DE NEOCONSERVADORISMO. UMA AGENDA CONSERVADORA, REACIONÁRIA E AUTORITÁRIA TEM SIDO APRESENTADA E, EM DIVERSOS PAÍSES, POLÍTICOS ALINHADOS A ESSES DISCURSOS FORAM ELEITOS. UM DOS TEMAS MAIS ATACADOS PELO NEOCONSERVADORISMO DIZ RESPEITO ÀS QUESTÕES DE GÊNERO E SEXUALIDADE. UM EXEMPLO É O FATO DE O BRASIL TER RETIRADO OS TERMOS "GÊNERO" E "ORIENTAÇÃO SEXUAL" DO PLANO NACIONAL DE EDUCAÇÃO EM 2014. VALE CONSIDERAR QUE A BASE NACIONAL COMUM CURRICULAR — BNCC — FOI APROVADA EM 2017. ESTE TRABALHO É PARTE DE UMA PESQUISA SOBRE GÊNERO NA ESCOLA E ANALISA ALGUMAS MUDANÇAS APROVADAS NA BNCC, SOBRETUDO AQUELAS QUE AFETARAM DIRETAMENTE A DISCIPLINA DE SOCIOLOGIA E A POSSIBILIDADE DE DESENVOLVER COM OS ALUNOS OS CONTEÚDOS DE GÊNERO E SEXUALIDADE. A PESQUISA É DESENVOLVIDA A PARTIR DE UMA BASE TEÓRICO-METODOLÓGICA DAS CIÊNCIAS SOCIAIS E DA ÁREA DE EDUCAÇÃO, SEGUNDO A QUAL ABORDAR QUESTÕES DE GÊNERO E SEXUALIDADE NA ESCOLA CONTRIBUI PARA A CONSOLIDAÇÃO DE UMA ESCOLA MAIS PLURAL, INCLUSIVA E DEMOCRÁTICA.',
      },
      {
