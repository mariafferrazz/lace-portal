...
const institutionalText = [
  "Esses pesquisadores, assim como todos os integrantes do LACE, reúnem neste espaço virtual pesquisas desenvolvidas sob perspectivas históricas e da teoria da memória, voltadas à defesa dos direitos humanos, da justiça e da cidadania, principalmente no que se refere às manifestações sociais na cidade e no campo. Entre elas estão os movimentos de resistência indígenas, quilombolas, operários, camponeses, ribeirinhos, LGBTQIA+, de mulheres, em defesa da educação e do meio ambiente, além dos movimentos organizados que denunciam a violência de Estado e preservam a memória registrada nos arquivos do Grupo Tortura Nunca Mais-RJ (GTNM/RJ).",
